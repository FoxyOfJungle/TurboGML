...
/// @desc Interpolates between a and b, based on value. Returns a value between 0 and 1, representing where the "value" parameter falls within the range defined by a and b. [Aka] inverse lerp.
///
